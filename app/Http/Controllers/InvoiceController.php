...
class InvoiceController extends Controller
{
    public function invoice(Request $request)
    {
        ...
        $myFileToJson = fopen("C:\laragon\www/tasheedtest\EInvoicing\SourceDocumentJson.json", "w") or die("unable to open file");
    ...
    public function openBat()
    {
        ...
        shell_exec('C:\laragon\www/tasheedtest\EInvoicing\SubmitInvoices2.bat');

        $path = "C:\laragon\www/tasheedtest\EInvoicing\FullSignedDocument.json";
        $path2 = "C:\laragon\www/tasheedtest\EInvoicing\Cades.txt";
        $path3 = "C:\laragon\www/tasheedtest\EInvoicing\CanonicalString.txt";
        $path4 = "C:\laragon\www/tasheedtest\EInvoicing\SourceDocumentJson.json";
